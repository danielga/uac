...
function uac.math.Add(a, b) -- only recommended for big numbers which Lua can't handle properly (must be positive integers)
...
function uac.math.Sub(a, b) -- only recommended for big numbers which Lua can't handle properly (must be positive integers)
	local A = APMakeTable(a)
	local B = APMakeTable(b)
