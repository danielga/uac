...
function PLUGIN:UsergroupPlayer(ply, command, args)
	local target = uac.player.GetTargets(ply, args[1], false)[1]
...
PLUGIN:AddCommand("rank", PLUGIN.UsergroupPlayer, ACCESS_SERVEROWNER, "Sets the usergroup of the specified user", "<Player name | SteamID | #UserID | @Team name> <Usergroup>")
...
PLUGIN:AddCommand("flags", PLUGIN.FlagPlayer, ACCESS_SERVEROWNER, "Sets the flags of the specified user", "<Player name | SteamID | #UserID | @Team name> <Flags>")
