...
CreateConVar("sb_version", "1.52", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY, "The current version of the SourceBans.lua module");
...
-- @release version 1.52 With added sm_*say commands and the SBANS_NO_COMMANDS directive
module("sourcebans");
--[[
